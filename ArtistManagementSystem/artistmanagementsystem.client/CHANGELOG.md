...
- Create Angular project with ng: `ng new artistmanagementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`artistmanagementsystem.client.esproj`).
